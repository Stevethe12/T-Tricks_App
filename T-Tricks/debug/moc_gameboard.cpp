...
QT_MOC_LITERAL(1, 10, 12), // "changerScore"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5) // "score"

    },
    "GameBoard\0changerScore\0\0score"
};
...
void GameBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changerScore((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameBoard::changerScore)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameBoard::changerScore(int _t1)
{
